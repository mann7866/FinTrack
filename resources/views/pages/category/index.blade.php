...
@section('content')
    <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
        ...
        <ul class="flex items-center gap-2 text-sm font-normal shrink-0">
            <li
                ...
                <a href="#!" class="text-slate-400 dark:text-zink-200">Kategori</a>
            </li>
    ...
    <div class="grid grid-cols-1 gap-x-5 xl:grid-cols-1">
                    ...
                    <table class="w-full">
                        ...
                        <tbody>
                            <tr class="odd:bg-slate-50 even:bg-white dark:odd:bg-zink-600 dark:even:bg-zink-700">
                                <td class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500">1</td>
                                <td class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500">Uang saku</td>
                                <td class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500">
                                    ...
                                    <button type="button"
                                        class="px-2 py-1 text-sm text-white bg-red-500 border-red-500 btn hover:text-white hover:bg-red-600 hover:border-red-600 focus:text-white focus:bg-red-600 focus:border-red-600 focus:ring focus:ring-red-100 active:text-white active:bg-red-600 active:border-red-600 active:ring active:ring-red-100 dark:ring-red-400/10">
                                        Hapus
                                    </button>
                                </td>
                            </tr>
        ...
        <div class="card">
            <div class="card-body">
                <div class="group flex justify-between items-center">
                    <h6 class="text-15">Table Metode Pembayaran</h6>
                    <a href=""
                        class="px-2 py-1 text-sm text-sky-500 bg-white border border-transparent btn hover:text-sky-100 hover:bg-white-600 hover:border-white-600 focus:outline-none focus:ring-0 focus:border-transparent active:outline-none active:ring-0 active:border-transparent">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                ...
                <div class="overflow-x-auto">
                    <table class="w-full">
                        ...
                        <tbody>
                            <tr class="odd:bg-slate-50 even:bg-white dark:odd:bg-zink-600 dark:even:bg-zink-700">
                                <td class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500">1</td>
                                <td class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500">Tunai</td>
                                <td class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500">
                                    <button type="button"
                                        class="px-2 py-1 text-sm text-white bg-yellow-500 border-yellow-500 btn hover:text-white hover:bg-yellow-600 hover:border-yellow-600 focus:text-white focus:bg-yellow-600 focus:border-yellow-600 focus:ring focus:ring-yellow-100 active:text-white active:bg-yellow-600 active:border-yellow-600 active:ring active:ring-yellow-100 dark:ring-yellow-400/10">
                                        Edit
                            ...
                            <tr class="odd:bg-slate-50 even:bg-white dark:odd:bg-zink-600 dark:even:bg-zink-700">
                                <td class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500">2</td>
                                <td class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500">Non Tunai</td>
                                <td class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500">
                                    <button type="button"
                                        class="px-2 py-1 text-sm text-white bg-yellow-500 border-yellow-500 btn hover:text-white hover:bg-yellow-600 hover:border-yellow-600 focus:text-white focus:bg-yellow-600 focus:border-yellow-600 focus:ring focus:ring-yellow-100 active:text-white active:bg-yellow-600 active:border-yellow-600 active:ring active:ring-yellow-100 dark:ring-yellow-400/10">
                                        Edit
